...
__parser: ArgumentParser = ArgumentParser(
    prog="iccl", description="Image complexity metrics analysis."
)

__sub_parser: _SubParsersAction = __parser.add_subparsers(
    dest="cmd", help="Command being executed."
)
...
__init_results: ArgumentParser = __sub_parser.add_parser(
    name="init-results", help="Initialize results file."
)

# RUN JOB ==========================================================================================
__job: ArgumentParser = __sub_parser.add_parser(name="run-job", help="Execute job.")
...
__curriculum.add_argument(
    ...
    action="store_true",
    default=False,
    help="Sort by the mean complexity value. Defaults to False.",
)

# RUN EXPERIENT ====================================================================================
__experiment: ArgumentParser = __sub_parser.add_parser(
    name="run-experiment", help="Execute experiment set."
)
