...
from numpy import argsort, ndarray, mean, abs
...
class Cifar10:
    ...
    def __init__(
        ...
        train_data = CIFAR10(root=path, download=True, train=True, transform=transform)
        ...
        test_data = CIFAR10(root=path, download=True, train=False, transform=transform)
